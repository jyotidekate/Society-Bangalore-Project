...
--
-- Table structure for table `fymaster`
--

DROP TABLE IF EXISTS `fymaster`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fymaster` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `fymaster`
--

LOCK TABLES `fymaster` WRITE;
/*!40000 ALTER TABLE `fymaster` DISABLE KEYS */;
/*!40000 ALTER TABLE `fymaster` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:45:43
