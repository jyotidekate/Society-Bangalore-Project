...
--
-- Table structure for table `recurring_due_report_model`
--

DROP TABLE IF EXISTS `recurring_due_report_model`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `recurring_due_report_model` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `recurring_due_report_model`
--

LOCK TABLES `recurring_due_report_model` WRITE;
/*!40000 ALTER TABLE `recurring_due_report_model` DISABLE KEYS */;
/*!40000 ALTER TABLE `recurring_due_report_model` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:45:25
