...
CREATE TABLE `locker_master` (
  ...
  `locker_location` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `locker_master` WRITE;
/*!40000 ALTER TABLE `locker_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `locker_master` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:45:00
