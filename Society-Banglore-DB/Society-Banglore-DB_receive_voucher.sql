...
DROP TABLE IF EXISTS `receive_voucher`;
...
CREATE TABLE `receive_voucher` (
  ...
  `direct_transfer` varchar(255) DEFAULT NULL,
...
LOCK TABLES `receive_voucher` WRITE;
/*!40000 ALTER TABLE `receive_voucher` DISABLE KEYS */;
/*!40000 ALTER TABLE `receive_voucher` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:42:30
