...
DROP TABLE IF EXISTS `journal_report`;
...
LOCK TABLES `journal_report` WRITE;
/*!40000 ALTER TABLE `journal_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `journal_report` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:44:18
