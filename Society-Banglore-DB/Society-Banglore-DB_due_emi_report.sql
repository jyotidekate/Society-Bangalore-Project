...
--
-- Table structure for table `due_emi_report`
--

DROP TABLE IF EXISTS `due_emi_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `due_emi_report` (
  `id` varchar(255) NOT NULL,
  `advisor_code` varchar(255) DEFAULT NULL,
  `branch` varchar(255) DEFAULT NULL,
  `interest_due` varchar(255) DEFAULT NULL,
  `interest_paid` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `due_emi_report`
--

LOCK TABLES `due_emi_report` WRITE;
/*!40000 ALTER TABLE `due_emi_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `due_emi_report` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:43:00
