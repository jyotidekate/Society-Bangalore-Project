...
--
-- Table structure for table `irregularemireport`
--

DROP TABLE IF EXISTS `irregularemireport`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `irregularemireport` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `irregularemireport`
--

LOCK TABLES `irregularemireport` WRITE;
/*!40000 ALTER TABLE `irregularemireport` DISABLE KEYS */;
/*!40000 ALTER TABLE `irregularemireport` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:43:15
