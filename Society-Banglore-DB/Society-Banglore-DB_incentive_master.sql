...
CREATE TABLE `incentive_master` (
  ...
  `invmonth` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `incentive_master`
--

LOCK TABLES `incentive_master` WRITE;
/*!40000 ALTER TABLE `incentive_master` DISABLE KEYS */;
INSERT INTO `incentive_master` VALUES (113,NULL,NULL,'806',NULL,'2024-06-17',NULL,'june',NULL,'ok','2024-06-24');
/*!40000 ALTER TABLE `incentive_master` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:45:16
