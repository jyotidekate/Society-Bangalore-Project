...
--
-- Table structure for table `regular_emi_report`
--

DROP TABLE IF EXISTS `regular_emi_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `regular_emi_report` (
  `id` int(11) NOT NULL,
  `branch` varchar(255) DEFAULT NULL,
  `chequeno` varchar(255) DEFAULT NULL,
  `collectorcode` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `regular_emi_report`
--

LOCK TABLES `regular_emi_report` WRITE;
/*!40000 ALTER TABLE `regular_emi_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `regular_emi_report` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:43:08
