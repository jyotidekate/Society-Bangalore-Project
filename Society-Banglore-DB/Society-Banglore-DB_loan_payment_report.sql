...
--
-- Table structure for table `loan_payment_report`
--

DROP TABLE IF EXISTS `loan_payment_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `loan_payment_report` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `loan_payment_report`
--

LOCK TABLES `loan_payment_report` WRITE;
/*!40000 ALTER TABLE `loan_payment_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `loan_payment_report` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:44:12
