...
DROP TABLE IF EXISTS `incentive_payment`;
...
CREATE TABLE `incentive_payment` (
  ...
  `selfbusiness` varchar(255) DEFAULT NULL,
  `servicecharge` varchar(255) DEFAULT NULL,
  `tds` varchar(255) DEFAULT NULL,
  `teambusiness` varchar(255) DEFAULT NULL,
  `totalbusiness` varchar(255) DEFAULT NULL,
  `totalincentive` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `incentive_payment`
--

LOCK TABLES `incentive_payment` WRITE;
/*!40000 ALTER TABLE `incentive_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `incentive_payment` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:42:26
