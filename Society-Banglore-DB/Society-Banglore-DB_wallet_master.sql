...
CREATE TABLE `wallet_master` (
  `id` int(11) NOT NULL,
  `imps_bal` varchar(255) DEFAULT NULL,
  `neft_bal` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `wallet_master` WRITE;
/*!40000 ALTER TABLE `wallet_master` DISABLE KEYS */;
INSERT INTO `wallet_master` VALUES (1,'1000','2000');
...
-- Dump completed on 2024-06-30 14:45:28
