...
--
-- Table structure for table `mis_payment_modal`
--

DROP TABLE IF EXISTS `mis_payment_modal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mis_payment_modal` (
  `policyno` int(11) NOT NULL,
  `applicantname` varchar(255) DEFAULT NULL,
  `intrestamount` double DEFAULT NULL,
  ...
  `policyamount` double DEFAULT NULL,
...
--
-- Dumping data for table `mis_payment_modal`
--

LOCK TABLES `mis_payment_modal` WRITE;
/*!40000 ALTER TABLE `mis_payment_modal` DISABLE KEYS */;
/*!40000 ALTER TABLE `mis_payment_modal` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-30 14:45:21
